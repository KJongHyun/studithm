...
import com.lightning.modules.gathering.event.GatheringCreatedEvent;
...
public class GatheringService {
    ...
    public void updateGatheringDescription(Gathering gathering, GatheringDescriptionForm gatheringDescriptionForm) {
        ...
        eventPublisher.publishEvent(new GatheringUpdateEvent(gathering, "모임 소개를 수정했습니다."));
    }
    ...
    public void close(Gathering gathering) {
        gathering.close();
        eventPublisher.publishEvent(new GatheringUpdateEvent(gathering, "모임을 종료했습니다."));
    }
